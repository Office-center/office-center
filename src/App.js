      ...
      <div>
        <header aria-label='barre de navigation' className='z-50 w-full py-2 flex justify-between fixed h-auto p-8 md:px-44 bg-secondairecard/75'>
          ...
          <div className={nav ? 'fixed left-0 top-[68px] w-[100%] h-full der-r-gray-100 ease-in-out duration-300' : 'ease-in-out duration-300 fixed left-[-100%] top-[68px]'} id="sidebar">
            <div className='flex flex-col text-[24px] bg-secondairecard/75'>
        ...
        <div className='main'>
          <div className='flex justify-center items-center'>
            ...
            <h1 className="bg-secondairecard/70 absolute text-sm font-bold text-secondaire text-center flex flex-col gap-y-[18px] p-4 rounded-md"><span className="text-[30px] text-secondaire">WORKUNION</span> <span>COWORKING - DOMICILIATION - LOCATION</span></h1>
          </div>
          <Specialites />
          <Vision />
          <Tarif />
