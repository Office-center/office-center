...
const Model = () => {
    ...
    return (
        <group dispose={null}>
        <group position={[0.02, 0.02, 0.01]} rotation={[-Math.PI / 2, x/100, y/100]} scale={1.5}>
          <mesh geometry={nodes['3D_Text_-_W_-_baked'].geometry} material={materials['Cosmic Aura 1']} position={[-30.35, 7.5, -15.81]} material-wireframe />
        </group>
      </group>
    )
  }
