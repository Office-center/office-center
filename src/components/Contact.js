                ...
                <div className="rounded-xl w-full flex justify-center mx-auto">
                    <form className="p-10 w-9/12 bg-white rounded-2xl shadow-lg" onSubmit={handleSubmit}>
                        ...
                        <div className="flex flex-col p-3">
                            <input className="h-10 p-4 text-sm font-light placeholder-gray-500 outline-none border-b-2 border-gray-200 focus:border-secondaire" placeholder="Nom" type="text" name="Prenom"  onChange={handleChange}/>
                            <p className="text-red-500 text-xs ml-4 mt-1">{formErr.name}</p>
                        </div>
                        <div className="flex flex-col p-3">
                            <input className="h-10 p-4 text-sm font-light placeholder-gray-500 outline-none border-b-2 border-gray-200 focus:border-secondaire" placeholder="Email" type="text" name="Nom"  onChange={handleChange}/>
                            <p className="text-red-500 text-xs ml-4 mt-1">{formErr.email}</p>
                        </div>
                        <div className="flex flex-col p-3">
                            <input className="h-10 p-4 text-sm font-light placeholder-gray-500 outline-none border-b-2 border-gray-200 focus:border-secondaire" placeholder="Sujet" type="text" name="Email"  onChange={handleChange}/>
                        </div>
                        ...
                        <input type="submit" className="p-2 w-1/3 ml-3 mt-2 rounded-full text-sm text-center text-white bg-principal hover:bg-white hover:text-principal duration-300 cursor-pointer" valuer="Envoyé" />
                    </form>
                </div>
            </div>
        </div>
